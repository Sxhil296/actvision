  ...
  return (
    <div className="section" id="about">
      <div className="grid md:grid-cols-2 gap-8 place-items-center">
        <div className="border-[3px] border-solid border-blue-500 rounded-lg">
        ...
        <div>
          ...
          <button className="py-3 px-6 text-sm border border-solid border-blue-500 hover:bg-blue-500 hover:text-white rounded-lg font-bold">
            Know More
          </button>
        </div>
      </div>
